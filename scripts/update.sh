...
update() {
  ...
  local ANSIBLE_ARGS_OXA_CONFIG="-i localhost, -c local -e @$OXA_TOOLS_PATH/config/server-vars.yml -e oxa_tools_path=$OXA_TOOLS_PATH -e oxa_tools_config_path=$OXA_TOOLS_CONFIG_PATH"
