...
echo "(change_date,enabled,icon_class,name,secondary,skip_registration_form,skip_email_verification,backend_name,third_party_auth_oauth2providerconfig.key,secret,other_settings,icon_image,site_id) " >> edxapp_aad.sql
echo " VALUES " >> edxapp_aad.sql
echo "(NOW(),1,'fa-sign-in','$4',0,1,1,'azuread-oauth2','$5','$6','','',1);" >> edxapp_aad.sql
