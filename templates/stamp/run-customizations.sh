...
help()
{
    ...
    echo "        --azure-cosmosdb-account-name Name of the CosmosDB (Mongo) account"
    echo "        --azure-cosmosdb-shared-access-key SAS key for the CosmosDB (Mongo) account"
}
